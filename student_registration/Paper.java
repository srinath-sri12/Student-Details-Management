...
public class Paper extends JFrame implements ActionListener,ItemListener{
	...
	public Paper(String name,String roll)
	{
		this.name=name;
		this.roll=roll;
		setLayout(null);
		...
		setSize(500,500);
		head=new JLabel("Enter Paper Presentation Details");
		Font  f1  = new Font(Font.DIALOG_INPUT,  Font.BOLD|Font.ITALIC, 15);
		head.setFont(f1);
		title=new JLabel("Title of the Paper : ");
	...
	public void addOperation()
	{
		...
		String sql = "INSERT INTO Paper VALUES('"+name+"','"+roll+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')";
